...
//     @Autowired
//     private int aiTanksCount;
    
//     @Autowired
//     private float tankMovementSpeed;
...
//             ObjectType.TANK, aiTanksCount + 1
//         );
...
//         List<TankModel> tanks = new ArrayList<>();
//         for (GridPoint2 tankPosition: objectsUniquePositions.get(ObjectType.TANK)) {
//             MoveBehavior tankMoveBehavior = new MoveBehavior(tankPosition, tankMovementSpeed, 0f, this);
//             TankModel tankModel = new TankModel(tankMoveBehavior, initialHealth);
//             tankModel.setObserver(observer);
//             tanks.add(tankModel);
//             mover.addMovableEntity(tankModel);
//             addObject(ObjectType.TANK, tankModel);
